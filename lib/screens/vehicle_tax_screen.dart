              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    ...
                    _buildPresetChip('B 1234 KZZ', month: '08', year: '28', labelNote: 'Kota Bekasi (Jabar)'),
                    _buildPresetChip('B 5678 FBA', month: '05', year: '29', labelNote: 'Kab. Bekasi / Cikarang (Jabar)'),
                    _buildPresetChip('B 8888 ZAB', month: '03', year: '24', labelNote: 'Depok (Jabar)'),
                    _buildPresetChip('F 2939 HC', month: '08', year: '27', labelNote: 'Kota Bogor (Jabar)'),
                    _buildPresetChip('D 1500 ABC', month: '09', year: '28', labelNote: 'Bandung (Jabar)'),
                    _buildPresetChip('B 1234 ABC', month: '10', year: '28', labelNote: 'Jakarta Utara (DKI)'),
                  ],
                ),
              ),
              const SizedBox(height: 16),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          Text(
            '💡 Ketuk huruf/angka plat atau kotak STNK di atas untuk mengedit langsung',
            textAlign: TextAlign.center,
